...
________________________________________
## **How to Install** 
### Clone the repository in [this](https://github.com/Jsosholberton/holbertonschool-AirBnB_clone) link or copy the text bellow.

```` 
git@github.com:Jsosholberton/holbertonschool-AirBnB_clone.git
````
________________________________________
...
## **Authors**
- [Johnatan Steven Ortiz](https://github.com/Jsosholberton)
